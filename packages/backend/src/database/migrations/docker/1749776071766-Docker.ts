...
export class Docker1749776071766 implements MigrationInterface {
    name = 'Docker1749776071766'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "challenge" ("id" SERIAL NOT NULL, "challengeInfo" text NOT NULL, "challengeType" "public"."challenge_challengetype_enum" NOT NULL, "duration" integer NOT NULL, "currentDay" integer NOT NULL DEFAULT '0', "startDate" date NOT NULL, "status" "public"."challenge_status_enum" NOT NULL DEFAULT 'enrollment', "creator" character varying(50) NOT NULL, CONSTRAINT "PK_5f31455ad09ea6a836a06871b7a" PRIMARY KEY ("id"))`);
