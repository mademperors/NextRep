...
export class TrainingAndMembers1749573242543 implements MigrationInterface {
    name = 'TrainingAndMembers1749573242543'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."member_gender_enum" AS ENUM('male', 'female', 'other')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."member_goal_enum" AS ENUM('lose_weight', 'gain_muscle', 'maintain_fitness')`);
